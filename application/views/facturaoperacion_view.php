...
<tr>
  ...
  <tr>
    ...
    <tr>
    <th><font face="Arial, Helvetica, sans-serif">Por concepto de</font></th>
    ...
    $tbl .= '
<tr>
    <td align="justify">' .  $value2['ope_observaciones'] . '</td>
    <td>$ ' .  $value2['ope_valor'] . '</td>
...
// This method has several options, check the source code documentation for more information.
    ...
    $pdf->Output('Factura_de_caja.pdf', 'I');
